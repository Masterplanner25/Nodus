...
nodus-lang is at **v4.0.6** (current stable on PyPI). The ecosystem spans **35 standalone
...
**Current version:** 4.0.6 (published to PyPI 2026-06-20)
...
| Publication status | **Published** — v4.0.6 live on PyPI |
