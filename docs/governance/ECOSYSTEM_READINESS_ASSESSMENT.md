...
nodus-lang is at **v5.3.0** (current stable on PyPI). The ecosystem spans **32 standalone
...
**Current version:** 5.3.0 (published to PyPI 2026-08-25)
...
| Publication status | **Published** — v5.3.0 live on PyPI |
...
- `docs/evals/v5.2.0/CREATOR_VALIDATION.md` — most recent Gate 10 results (v5.2.0 cycle)
