...
nodus-lang is at **v5.0.2** (current stable on PyPI; 5.0.3 in flight). The ecosystem spans **32 standalone
...
**Current version:** 4.1.1 (published to PyPI 2026-08-05)
...
| Publication status | **Published** — v4.1.1 live on PyPI |
