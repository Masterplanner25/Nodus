...
nodus-lang is at **v5.14.0** (current stable on PyPI). The ecosystem spans **36 standalone
...
**Current version:** 5.14.0 (published to PyPI 2026-09-18)
...
| Publication status | **Published** — v5.14.0 live on PyPI |
