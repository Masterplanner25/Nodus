...
nodus-lang is at **v5.2.0** (current stable on PyPI). The ecosystem spans **32 standalone
...
**Current version:** 5.2.0 (published to PyPI 2026-08-23)
...
| Publication status | **Published** — v5.2.0 live on PyPI |
