...
nodus-lang is at **v5.13.0** (current stable on PyPI). The ecosystem spans **36 standalone
...
**Current version:** 5.13.0 (published to PyPI 2026-09-08)
...
| Publication status | **Published** — v5.13.0 live on PyPI |
...
**Is the Nodus ecosystem real?** Yes. 33 PyPI projects exist as real GitHub repos with real
...
- `docs/history/ECOSYSTEM_90_DAY_CHECKLIST.md` — what to complete before production
- `docs/governance/LIBRARY_ECOSYSTEM.md` — ecosystem architecture
- `docs/evals/v5.12.0/CREATOR_VALIDATION.md` — most recent Gate 10 results (v5.12.0 cycle)
