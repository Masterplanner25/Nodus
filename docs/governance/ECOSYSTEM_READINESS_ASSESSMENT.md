...
nodus-lang is at **v5.10.0** (current stable on PyPI). The ecosystem spans **36 standalone
...
**Current version:** 5.10.0 (published to PyPI 2026-09-05)
...
| Publication status | **Published** — v5.10.0 live on PyPI |
...
- `docs/evals/v5.10.0/CREATOR_VALIDATION.md` — most recent Gate 10 results (v5.10.0 cycle)
